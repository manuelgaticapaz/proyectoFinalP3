...
from .views import PatientsViewSet # Asegúrate de que el nombre de tu ViewSet sea este o cámbialo
...
router.register(r'paciente', PatientsViewSet, basename='patient')
